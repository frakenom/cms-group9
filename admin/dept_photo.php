...
if( isset( $_FILES['image'] ) )
{
  ...
  set_message( 'Department photo has been updated' );
...
if( isset( $_GET['id'] ) )
{
  ...
  if( isset( $_GET['delete'] ) )
  {
    ...
    set_message( 'Department photo has been deleted' );
...
<?php if( $record['image'] ): ?>
  ...
  <p><a href="dept_photo.php?id=<?php echo $_GET['id']; ?>&delete"><i class="fas fa-trash-alt"></i> Delete this Photo</a></p>
